...
public class CodeParser<Node: CodeNodeElement, Token: CodeTokenElement>
where Node: CodeNodeElement, Token: CodeTokenElement {
  ...
  ///   errors encountered.
  public func parse(_ source: String, language: any CodeLanguage<Node, Token>) -> CodeParseResult<
    Node, Token
  > {
