...
struct MarkdownHTMLBlocksTests {
  ...
  func basicTableHTMLBlock() {
    ...
    let expectedSig =
      #"document[html_block(name:"",content:"<table>\#n  <tr>\#n    <td>\#n           hi\#n    </td>\#n  </tr>\#n</table>"),paragraph[text("okay.")]]"#
  ...
  func divHTMLBlockWithLiteralContent() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:" <div>\#n  *hello*\#n         <foo><a>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func closingTagStartsHTMLBlock() {
    ...
    // Verify AST structure using sig
    let expectedSig = #"document[html_block(name:"",content:"</div>\#n*foo*")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func htmlBlocksWithMarkdownBetween() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<DIV CLASS="foo">"),paragraph[emphasis[text("Markdown")]],html_block(name:"",content:"</DIV>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func partialTagSplitAcrossLines() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<div id="foo"\#n  class="bar">\#n</div>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func partialTagWithAttributeSplit() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<div id="foo" class="bar\#n  baz">\#n</div>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func openTagWithoutClosing() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<div>\#n*foo*"),paragraph[emphasis[text("bar")]]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func incompletePartialTag() {
    ...
    // Verify AST structure using sig
    let expectedSig = #"document[html_block(name:"",content:"<div id="foo"\#n*hi*")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func tableHTMLBlockContinuation() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<table><tr><td>\#nfoo\#n</td></tr></table>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func htmlBlockIncludesFencedCode() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<div></div>\#n``` c\#nint x = 33;\#n```")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type7HTMLBlockCustomTag() {
    ...
    // Verify AST structure using sig
    let expectedSig = #"document[html_block(name:"",content:"<a href="foo">\#n*bar*\#n</a>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type7HTMLBlockWarningTag() {
    ...
    // Verify AST structure using sig
    let expectedSig = #"document[html_block(name:"",content:"<Warning>\#n*bar*\#n</Warning>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func delTagHTMLBlock() {
    ...
    // Verify AST structure using sig
    let expectedSig = #"document[html_block(name:"",content:"<del>\#n*foo*\#n</del>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func delTagWithBlankLineAllowsMarkdown() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<del>"),paragraph[emphasis[text("foo")]],html_block(name:"",content:"</del>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type1HTMLBlockPreTag() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<pre language="haskell"><code>\#nimport Text.HTML.TagSoup\#n\#nmain :: IO ()\#nmain = print $ parseTags tags\#n</code></pre>"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type1HTMLBlockScriptTag() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<script type="text/javascript">\#n// JavaScript example\#n\#ndocument.getElementById("demo").innerHTML = "Hello JavaScript!";\#n</script>"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type1HTMLBlockStyleTag() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<style\#n  type="text/css">\#nh1 {color:red;}\#n\#np {color:blue;}\#n</style>"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type2HTMLBlockComment() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<!-- Foo\#n\#nbar\#n   baz -->"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type3HTMLBlockProcessingInstruction() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<?php\#n\#n  echo '>';\#n\#n?>"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type5HTMLBlockCDATA() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[html_block(name:"",content:"<![CDATA[\#nfunction matchwo(a,b)\#n{\#n  if (a < b && a < 0) then {\#n    return 1;\#n\#n  } else {\#n\#n    return 0;\#n  }\#n}\#n]]>"),paragraph[text("okay")]]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func htmlBlockCanInterruptParagraph() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[paragraph[text("Foo")],html_block(name:"",content:"<div>\#nbar\#n</div>")]"#
    #expect(sig(result.root) == expectedSig)
  }
  ...
  func type7CannotInterruptParagraph() {
    ...
    // Verify AST structure using sig
    let expectedSig =
      #"document[paragraph[text("Foo"),line_break(soft),html("<a href="bar">"),line_break(soft),text("baz")]]"#
    #expect(sig(result.root) == expectedSig)
  }
}
