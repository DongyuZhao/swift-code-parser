...
struct MarkdownLinksTests {
  ...
  func linkDestinationWithLineBreaksNotParsedAsLink() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[text("[link](foo"),line_break(soft),text("bar)")]]"#)
  }
  ...
  func linkDestinationWithLineBreaksInPointyBracketsNotParsedAsLink() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[link](<foo"),line_break(soft),text("bar>)")]]"#)
  }
  ...
  func unmatchedPointyBracketsDoNotCreateLinks() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[a](<b)c"),line_break(soft),text("[a](<b)c>"),line_break(soft),text("[a](<b>c)")]]"#
    )
  }
  ...
  func balancedParenthesesInLinkDestination() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[link(url:"foo(and(bar))",title:"")[text("link")]]]"#)
  }
  ...
  func linkWithFragmentIdentifiersAndQueries() {
    ...
    #expect(
      sig(result.root)
        == ##"document[paragraph[link(url:"#fragment",title:"")[text("link")]],paragraph[link(url:"http://example.com#fragment",title:"")[text("link")]],paragraph[link(url:"http://example.com?foo=3#frag",title:"")[text("link")]]]"##
    )
  }
  ...
  func backslashBeforeNonEscapableCharacterRemainsAsBackslash() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[link(url:"foo%5Cbar",title:"")[text("link")]]]"#)
  }
  ...
  func titlesInDifferentQuoteTypes() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title")[text("link")],line_break(soft),link(url:"/url",title:"title")[text("link")],line_break(soft),link(url:"/url",title:"title")[text("link")]]]"#
    )
  }
  ...
  func backslashEscapesAndEntitiesInTitles() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title \"&quot;\"")[text("link")]]]"#)
  }
  ...
  func nonBreakingSpaceInTitleUrlEncodes() {
    ...
    let input = #"""
      [link]("title\#u{00A0}here")
      """#
    let result = parser.parse(input, language: language)

    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"%22title%C2%A0here%22",title:"")[text("link")]]]"#)
  }
  ...
  func nestedBalancedQuotesNotAllowedWithoutEscaping() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[text("[link](/url \"title \"and\" title\")")]]"#)
  }
  ...
  func usingDifferentQuoteTypeForNestedQuotes() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title \"and\" title")[text("link")]]]"#)
  }
  ...
  func linkTextWithBalancedBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("link [foo [bar]]")]]]"#)
  }
  ...
  func unbalancedOpeningBracketCreatesNestedLink() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[link "),link(url:"/uri",title:"")[text("bar")]]]"#)
  }
  ...
  func escapedBracketInLinkText() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[link(url:"/uri",title:"")[text("link [bar")]]]"#)
  }
  ...
  func linkTextWithInlineFormatting() {
    ...
    #expect(
      sig(result.root)
  == ##"document[paragraph[link(url:"/uri",title:"")[text("link "),emphasis[text("foo "),strong[text("bar")],text(" "),code("#")]]]]"##
    )
  }
  ...
  func linksMayNotContainOtherLinks() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo "),link(url:"/uri",title:"")[text("bar")],text("](/uri)")]]"#
    )
  }
  ...
  func complexNestedLinkStructure() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo "),emphasis[text("[bar "),link(url:"/uri",title:"")[text("baz")],text("](/uri)")],text("](/uri)")]]"#
    )
  }
  ...
  func imageWithNestedLinkStructure() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[image(url:"uri3",alt:"[foo](uri2)",title:"")]]"#)
  }
  ...
  func linkTextGroupingTakesPrecedenceOverEmphasisGrouping() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("*"),link(url:"/uri",title:"")[text("foo*")]]]"#)
  }
  ...
  func linkTextGroupingWithEmphasisInDestination() {
    ...
    #expect(
      sig(result.root) == #"document[paragraph[link(url:"baz*",title:"")[text("foo *bar")]]]"#)
  }
  ...
  func autolinksGroupMoreTightlyThanLinkGrouping() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo"),link(url:"http://example.com/?search=%5D(uri)",title:"")[text("http://example.com/?search=](uri)")]]]"#
    )
  }
  ...
  func simpleFullReferenceLink() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title")[text("foo")]],reference(id:"bar",url:"/url",title:"title")]"#
    )
  }
  ...
  func fullReferenceLinkWithBalancedBracketsInText() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("link [foo [bar]]")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinkWithEscapedBracketInText() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("link [bar")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinkWithInlineFormattingInText() {
    ...
    #expect(
      sig(result.root)
        == ##"document[paragraph[link(url:"/uri",title:"")[text("link "),emphasis[text("foo "),strong[text("bar")],text(" "),code("#")]],reference(id:"ref",url:"/uri",title:"")]"##
    )
  }
  ...
  func fullReferenceLinkContainingImage() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[image(url:"moon.jpg",alt:"moon",title:"")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinksCannotContainOtherLinks() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("foo [bar](/uri)")],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinkWithNestedEmphasisAndLinks() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("foo "),emphasis[text("bar [baz][ref]")]]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinkTextGroupingOverEmphasis() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("*"),link(url:"/uri",title:"")[text("foo*")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func fullReferenceLinkTextWithEmphasisMarker() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("foo *bar")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func htmlTagsPrecedenceOverReferenceLinkGrouping() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo <bar attr=\"][ref]\">")],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func codeSpansPrecedenceOverReferenceLinkGrouping() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo"),code("][ref]")],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func autolinksPrecedenceOverReferenceLinkGrouping() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo"),link(url:"http://example.com/?search=%5D%5Bref%5D",title:"")[text("http://example.com/?search=][ref]")]],reference(id:"ref",url:"/uri",title:"")]"#
    )
  }
  ...
  func unicodeCaseFoldIsUsedForMatching() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"")[text("Толпой")],text(" is a Russian word.")],reference(id:"ТОЛПОЙ",url:"/url",title:"")]"#
    )
  }
  ...
  func consecutiveInternalWhitespaceTreatedAsOneSpace() {
    ...
    #expect(
      sig(result.root)
        == #"document[reference(id:"Foo bar",url:"/url",title:""),paragraph[link(url:"/url",title:"")[text("Baz")]]]"#
    )
  }
  ...
  func noWhitespaceAllowedBetweenLinkTextAndLabel() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo] "),link(url:"/url",title:"title")[text("bar")]],reference(id:"bar",url:"/url",title:"title")]"#
    )
  }
  ...
  func noNewlineAllowedBetweenLinkTextAndLabel() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo]"),line_break(soft),link(url:"/url",title:"title")[text("bar")]],reference(id:"bar",url:"/url",title:"title")]"#
    )
  }
  ...
  func firstMatchingReferenceDefinitionIsUsed() {
    ...
    #expect(
      sig(result.root)
        == #"document[reference(id:"foo",url:"/url1",title:""),reference(id:"foo",url:"/url2",title:""),paragraph[link(url:"/url1",title:"")[text("bar")]]]"#
    )
  }
  ...
  func matchingPerformedOnNormalizedStringsNotParsedContent() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[bar][foo!]")],reference(id:"foo!",url:"/url",title:"")]"#
    )
  }
  ...
  func linkLabelsCannotContainUnescapedBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo][ref[]")],paragraph[text("[ref[]: /uri")]]"#)
  }
  ...
  func linkLabelsWithNestedBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo][ref[bar]]")],paragraph[text("[ref[bar]]: /uri")]]"#)
  }
  ...
  func linkLabelsWithTripleNestedBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[[[foo]]]")],paragraph[text("[[[foo]]]: /url")]]"#)
  }
  ...
  func linkLabelsCanContainEscapedBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/uri",title:"")[text("foo")]],reference(id:"ref[",url:"/uri",title:"")]"#
    )
  }
  ...
  func backslashAtEndOfReferenceDefinition() {
    ...
    #expect(
      sig(result.root)
        == #"document[reference(id:"bar\",url:"/uri",title:""),paragraph[link(url:"/uri",title:"")[text("bar\")]]]"#
    )
  }
  ...
  func linkLabelWithOnlyWhitespace() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("["),line_break(soft),text(" ]")],paragraph[text("["),line_break(soft),text(" ]: /uri")]]"#
    )
  }
  ...
  func simpleCollapsedReferenceLink() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title")[text("foo")]],reference(id:"foo",url:"/url",title:"title")]"#
    )
  }
  ...
  func collapsedReferenceLinkWithFormatting() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title")[emphasis[text("foo")],text(" bar")]],reference(id:"*foo* bar",url:"/url",title:"title")]"#
    )
  }
  ...
  func collapsedReferenceLinkNoWhitespaceBetweenBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"title")[text("foo")],line_break(soft),text("[]")],reference(id:"foo",url:"/url",title:"title")]"#
    )
  }
  ...
  func shortcutReferenceLinkWithDoubleBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("["),link(url:"/url",title:"title")[emphasis[text("foo")],text(" bar")],text("]")],reference(id:"*foo* bar",url:"/url",title:"title")]"#
    )
  }
  ...
  func shortcutReferenceLinkWithUnmatchedBracket() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[[bar "),link(url:"/url",title:"")[text("foo")]],reference(id:"foo",url:"/url",title:"")]"#
    )
  }
  ...
  func spaceAfterShortcutReferenceLinkTextIsPreserved() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url",title:"")[text("foo")],text(" bar")],reference(id:"foo",url:"/url",title:"")]"#
    )
  }
  ...
  func linkLabelEndsWithFirstClosingBracket() {
    ...
    #expect(
      sig(result.root)
        == #"document[reference(id:"foo*",url:"/url",title:""),paragraph[text("*"),link(url:"/url",title:"")[text("foo*")]]]"#
    )
  }
  ...
  func fullReferenceLinksTaskePrecedenceOverShortcut() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url2",title:"")[text("foo")]],reference(id:"foo",url:"/url1",title:""),reference(id:"bar",url:"/url2",title:"")]"#
    )
  }
  ...
  func collapsedReferenceLinksTaskePrecedenceOverShortcut() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url1",title:"")[text("foo")]],reference(id:"foo",url:"/url1",title:"")]"#
    )
  }
  ...
  func inlineLinksTaskePrecedenceOverReferenceLinks() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"",title:"")[text("foo")]],reference(id:"foo",url:"/url1",title:"")]"#
    )
  }
  ...
  func referenceLinkFallbackWhenInlineLinkInvalid() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url1",title:"")[text("foo")],text("(not a link)")],reference(id:"foo",url:"/url1",title:"")]"#
    )
  }
  ...
  func referenceParsingPrecedenceWithMultipleBrackets() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo]"),link(url:"/url",title:"")[text("bar")]],reference(id:"baz",url:"/url",title:"")]"#
    )
  }
  ...
  func referenceParsingWithDefinedBar() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[link(url:"/url2",title:"")[text("foo")],link(url:"/url1",title:"")[text("baz")]],reference(id:"baz",url:"/url1",title:""),reference(id:"bar",url:"/url2",title:"")]"#
    )
  }
  ...
  func shortcutReferenceNotParsedWhenFollowedByLinkLabel() {
    ...
    #expect(
      sig(result.root)
        == #"document[paragraph[text("[foo]"),link(url:"/url1",title:"")[text("bar")]],reference(id:"baz",url:"/url1",title:""),reference(id:"foo",url:"/url2",title:"")]"#
    )
  }
}
